...
@php
    ...
    // ===== แปลงรูปด้านหลัง =====
    $behind = $sale->product_images_behind;

    if (is_string($behind)) {
        $behind = json_decode($behind, true);
    }
    $productBehindImages = $behind ?? [];
@endphp
    ...
    <div class="receipt-container">
        ...
        <div style="width:100%; padding:10px;">
            ...
            <div style="text-align:center; margin-top:10px;">
                ...
                <!-- รูปสินค้า (ด้านหลัง) -->
                @if (!empty($productBehindImages))
                    @foreach ($productBehindImages as $img)
                        <img src="{{ asset('storage/' . $img) }}" style="width:150px; height:180px; object-fit:cover;">
                    @endforeach
                @endif
